*** Settings ***
Documentation   It opens login page * logs in as municipal admin * adds a municipal manager * and enables him.
Resource    ../resources/common.resource

*** Variables ***
${manager_email}    arturart@citytax.xyz
...
# enables new saved employee
    ...
    Click Button    id=municipality-employees-status-modal-confirm
